      ...
      <ion-list>
        <ion-item>
          <ion-label position="stacked">
            Età attuale: {{ userStore.userData.eta ?? 'N/A' }}
          </ion-label>
        ...
        <ion-item>
          <ion-label position="stacked">
            Sesso attuale: {{ userStore.userData.sesso ?? 'N/A' }}
          </ion-label>
        ...
        <ion-item>
          <ion-label position="stacked">
            Altezza attuale: {{ userStore.userData.altezza ?? 'N/A' }} cm
          </ion-label>
        ...
        <ion-item>
          <ion-label position="stacked">
            Peso attuale: {{ userStore.userData.peso ?? 'N/A' }} kg
          </ion-label>
...
function salvaDati() {
  userStore.setUserField('eta', eta.value)
  userStore.setUserField('sesso', sesso.value)
  userStore.setUserField('altezza', altezza.value)
  userStore.setUserField('peso', peso.value)
